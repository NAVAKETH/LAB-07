...
time	|ใช่ได้|ไม่มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ	
do	|ใช่ไม่ได้|เป็นคำสงวนในภาษา C# ใช้ในลูปwhile			
Do	|ใช่ได้ |ไม่มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ			
21November	|ใช่ไม่ได้|มีเครื่องหมายทางคณิตศาสตร์อยู่ในชื่อ		
ladkrabang	|ใช่้ได้ |ไม่มีตัวอักษรที่ละเมิดกฎการตั้งชื่อ		
Student ID	|ใช่ไม่ได้ |มีการเว้นวรรค			
...
10.	100*x+y%2-a
```
![](https://github.com/NAVAKETH/LAB-07/blob/master/samakarn1.PNG?raw=true)
